...
public class CheckDroneAvailableServiceLocator extends org.apache.axis.client.Service implements iis.project.jpa.webservices.CheckDroneAvailableService {
    ...
    private java.lang.String CheckDroneAvailablePort_address = "http://localhost:8080/drone-order-war/CheckDroneAvailable";
    ...
    public iis.project.jpa.webservices.CheckDroneAvailable getCheckDroneAvailablePort() throws javax.xml.rpc.ServiceException {
    ...
    public iis.project.jpa.webservices.CheckDroneAvailable getCheckDroneAvailablePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            iis.project.jpa.webservices.CheckDroneAvailableServiceSoapBindingStub _stub = new iis.project.jpa.webservices.CheckDroneAvailableServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (iis.project.jpa.webservices.CheckDroneAvailable.class.isAssignableFrom(serviceEndpointInterface)) {
                iis.project.jpa.webservices.CheckDroneAvailableServiceSoapBindingStub _stub = new iis.project.jpa.webservices.CheckDroneAvailableServiceSoapBindingStub(new java.net.URL(CheckDroneAvailablePort_address), this);
                _stub.setPortName(getCheckDroneAvailablePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webservices.jpa.project.iis/", "CheckDroneAvailableService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webservices.jpa.project.iis/", "CheckDroneAvailablePort"));
        }
